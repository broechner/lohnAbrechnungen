  ...
  return (
    <section className="brand-panel mx-auto mt-16 max-w-md rounded-[28px] p-8">
      <div className="flex items-center gap-4">
        <div className="grid h-14 w-14 place-items-center rounded-3xl bg-accent-gradient shadow-[0_16px_36px_rgba(255,88,0,0.25)]">
        ...
        <div>
          <p className="brand-accent-text text-xs uppercase tracking-[0.24em]">Avanade Access</p>
